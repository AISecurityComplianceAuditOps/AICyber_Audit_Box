# AICyberAuditBox v3.17 - Customer Quickstart

## What's in your delivery
You received two files:
  1. aicyberauditbox_bundle_v3.17.tar      -- All Docker images (~7 GB, air-gapped)
  2. aicyberauditbox_bundle_v3.17_companion.zip -- This guide + docker-compose.customer.yml
