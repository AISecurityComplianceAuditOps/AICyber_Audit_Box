# AICyberAuditBox v3.20 — Deployment Guide
...
| File | Size | Contents |
|---|---|---|
| `aicyberauditbox_bundle_v3.20.tar` | 7.78 GB | All five Docker images |
| `aicyberauditbox_bundle_v3.20_companion.zip` | ~30 KB | This guide, `docker-compose.customer.yml`, benchmarking tools |
...
```
docker load -i aicyberauditbox_bundle_v3.20.tar
```
